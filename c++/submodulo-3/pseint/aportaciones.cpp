...
int main() {
    // Declarar vairables
    int aportacion, aportacion10 = 0, aportacion15 = 0, aportacion20 = 0, aportacion_others = 0, total;
    ...
    total = (aportacion10 * 10) + (aportacion15 * 15)+ (aportacion20 * 20) + aportacion_others;

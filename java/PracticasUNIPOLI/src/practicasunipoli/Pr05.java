...
public class Pr05 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkDog = new javax.swing.JCheckBox();
        checkCat = new javax.swing.JCheckBox();
        checkRat = new javax.swing.JCheckBox();
        jToggleButton1 = new javax.swing.JToggleButton();
        labelResult = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        checkDog.setText("Dog");

        checkCat.setText("Cat");

        checkRat.setText("Rat");
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        String message = "Your selected animals are: ";
        message += (checkDog.isSelected()) ? "Dog, " : "";
        message += (checkCat.isSelected()) ? "Cat, " : "";
        message += (checkRat.isSelected()) ? "Rat " : "";
    ...
    private javax.swing.JCheckBox checkDog;
    private javax.swing.JCheckBox checkRat;
